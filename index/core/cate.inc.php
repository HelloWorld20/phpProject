...
function addCate(){
	$arr=$_POST;
	if(insert(connect(),"imooc_cate",$arr)){
		$mes="分类添加成功<a href='../admin.php#_3'>继续添加</a>|<a href='../admin.php#_4>查看分类</a>";
	}else{
		$mes="分类添加失败<a href='../admin.php#_3'>重新添加</a>|<a href='../admin.php#_4>查看分类</a>";
	}
	return $mes;
}

function getPartCate($begin,$num){
	$sql="select id,cName from imooc_cate limit {$begin},{$num}";
